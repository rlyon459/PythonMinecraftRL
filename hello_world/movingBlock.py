...
def calculateMove():
    """ Changes the x and z variables for a block.  If the block in from of the block is less than 2 blocks higher, it will move forward;  otherwise it will try to move left, then backward, then finally right"""
    global pos
    global x
    global z
    global y
